 ...
 */
package se.sics.kompics.simutil.msg.impl;

import se.sics.kompics.network.Address;
import se.sics.kompics.network.Transport;
import se.sics.kompics.simutil.msg.Header2;
import se.sics.kompics.simutil.identifiable.Identifier;

/**
 * @author Alex Ormenisan <aaor@sics.se>
 */
public class DecoratedHeader<Adr extends Address> implements Header2<Adr> {
